...
int main()
{
   ...
   * limite sarà gestito comunicandone l'esistenza all'utente tramite la stampa
...
nonche' quelli in cui le parole sono separate da più di uno spazio.
...
spazio tra le parole, nonché la presenza di spazi tra inizio della frase e
