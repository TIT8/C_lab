...
Esercizio A (modificato per eliminare i riferimenti a funzioni e liste dinamiche). La soluzione della versione non modificata dell'esercizio verra' illustrata più avanti nel corso.
